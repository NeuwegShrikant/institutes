                    ...
                    <div class="kt-section__content">
                        ...
                        <div class="row">
                            <div style="border-right:1px solid lightgrey;" class="col-4 px-4">
                                @include('admin.masters.sessions.create')
                            </div>
                                ...
                                <table class="data-table table  table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @else 
                                            ...
                                            <tr>
                                                <td>{{ $model->id }}</td>
                                                <td> {{ $model->start_year.'-'.$model->end_year }} 
                                                    @if($model->is_current)
                                                        <span class="kt-badge  kt-badge--success kt-badge--inline kt-badge--pill">Current</span>
                                                    @endif
                                                </td>
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $('.session-menu').addClass('kt-menu__item--active');
        });
    </script>
@stop